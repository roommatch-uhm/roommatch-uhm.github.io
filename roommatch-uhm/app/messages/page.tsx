  ...
  const [chats, setChats] = useState<Chat[]>([
    {
      id: 1,
      name: "Jamie Fleming",
      photo: "/images/Jamie-Fleming.png",
      messages: [
        { id: 1, sender: "Jamie", text: "Hey! Want to meet later?", time: "9:00 AM" },
    ...
    },
    {
      id: 2,
      name: "Grace Liu",
      photo: "/images/Grace-Liu.png",
      messages: [
        { id: 1, sender: "Grace", text: "Hi! Are you still looking for a roommate?", time: "10:10 AM" },
