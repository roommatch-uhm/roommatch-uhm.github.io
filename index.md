...
<img src="img/matches-page1.png" alt="Matches Page Screenshot 1">
<img src="img/matches-page2.png" alt="Matches Page Screenshot 2">
...
<img src="img/profile-page1.png" alt="Profile Page Screenshot">
...
<img src="img/create-profile-page.png" alt="Create Profile Screenshot">

<h3>Messages Page</h3>
<p>
  The Messages Page enables users to chat directly with potential or matched roommates. 
  Designed for clean, easy communication on both mobile and desktop.
</p>
<ul>
  <li>Chat interface with message bubbles.</li>
  <li>List of conversations on the left, selected conversation on the right.</li>
  <li>User profile pictures for identification.</li>
